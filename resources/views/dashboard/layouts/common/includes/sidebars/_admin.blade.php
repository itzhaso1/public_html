<div class="sidebar">
    ...
    <!-- Products Menu -->
    <div data-kt-menu-trigger="click" class="menu-item menu-accordion {{ is_active('admin.products.*') || is_active('admin.manual_payments.*') || is_active('admin.diamond_codes.*') }}">
